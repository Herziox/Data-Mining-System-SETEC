...
def search_query_on_page(driver,QUERY_INPUT):
  ...
  cmb_module = driver.find_element(By.LINK_TEXT, 'CNC - Perfiles Inhabilitados')
...
#TRY TO LOAD PAGE
  while(try_load):
    ...
    try:
      ...
      #GET LAST PAGE
      btn_control = driver.find_element(By.XPATH,'//*[@id="j_idt24:j_idt116:tbl_paginator_bottom"]/a[4]')
  ...
  while(go):  
    ...
    while(try_load):
      ...
      try:
        ...
        report_file.close()
        ## GET TABLE HEADER
        table_header = driver.find_element(By.ID,'j_idt24:j_idt116:tbl_head')
    ...
    while(page_number<page_checkpoint and page_number<final_page and not expired_session):
        try:
            ...
            btn_siguiente = driver.find_element(By.XPATH, '//*[@id="j_idt24:j_idt116:tbl_paginator_bottom"]/a[3]')

            if (page_checkpoint - page_number)>10:
              btn_siguiente = driver.find_element(By.XPATH,'//*[@id="j_idt24:j_idt116:tbl_paginator_bottom"]/span/a[10]')
    ...
    if (page_number >= final_page):
      ...
      while(condition):
        ...
        while(try_load):
          try:
            table_data = driver.find_element(By.ID,'j_idt24:j_idt116:tbl_data')
