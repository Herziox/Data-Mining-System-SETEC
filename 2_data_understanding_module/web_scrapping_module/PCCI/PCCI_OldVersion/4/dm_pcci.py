...
def search_query_on_page(driver,QUERY_INPUT):
  ## URL
  driver.get('http://portal.trabajo.gob.ec/setec-portal-web/pages/personasCapacitadas.jsf')

  ## SELECT MODULE
  driver.implicitly_wait(5)
  cmb_module = driver.find_element(By.LINK_TEXT, 'Búsqueda de Personas Capacitadas')
  driver.execute_script('arguments[0].click()',cmb_module)

  ## SELECT FILTER
  driver.implicitly_wait(5)
  cmb_seleccione_filtro = driver.find_element(By.ID, 'j_idt24:frmCapIndPersonas:cmbSubOcIndependiente:cmbSubOcIndependiente_label')
...
#TRY TO LOAD PAGE
  while(try_load):
    ...
    try:
      ...
      #GET LAST PAGE
      btn_control = driver.find_element(By.XPATH,str_btn_control)
  ...
  while(go):  
    ...
    while(try_load):
      ...
      try:
        ...
        report_file.close()
        ## GET TABLE HEADER
        table_header = driver.find_element(By.ID,str_table_header)
    ...
    while(page_number<page_checkpoint and page_number<final_page and not expired_session):
        try:
            ...
            btn_siguiente = driver.find_element(By.XPATH, str_btn_siguiente)

            if (page_checkpoint - page_number)>10:
              btn_siguiente = driver.find_element(By.XPATH,str_btn_siguiente_jump)
    ...
    if (page_number >= final_page):
      ...
      while(condition):
        ...
        while(try_load):
          try:
            table_data = driver.find_element(By.ID,str_table_data)
...
if __name__==('__main__'):
    ...
    str_table_header = 'j_idt24:frmCapIndPersonas:tbl4_head'
    str_btn_control = '//*[@id="j_idt24:frmCapIndPersonas:tbl4_paginator_bottom"]/a[4]'
    str_btn_siguiente = '//*[@id="j_idt24:frmCapIndPersonas:tbl4_paginator_bottom"]/a[3]'
    str_btn_siguiente_jump = '//*[@id="j_idt24:frmCapIndPersonas:tbl4_paginator_bottom"]/span/a[10]'
    str_table_data = 'j_idt24:frmCapIndPersonas:tbl4_data'
    ...
    bot(3,DOC_NAME,options,10848,14464,QUERY_INPUT)
    '''
    for i in range(N_BOT_DRIVERS):
