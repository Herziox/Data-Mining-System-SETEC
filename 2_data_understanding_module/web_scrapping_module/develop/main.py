...
def search_query_on_page(driver,QUERY_INPUT):
  ...
  cmb_module = driver.find_element(By.LINK_TEXT, 'CNC para Operadores de Capacitación')
  ...
  ## SELECT FILTER
  driver.implicitly_wait(5)
  cmb_seleccione_filtro = driver.find_element(By.ID, 'j_idt24:formCatalogoOC:cmbCampo:cmbCampo_label')
  cmb_seleccione_filtro.click()

  ## SELECT OPTION
  driver.implicitly_wait(5)
  cmb_item_nombre_curso = driver.find_element(By.ID, 'j_idt24:formCatalogoOC:cmbCampo:cmbCampo_4')
  cmb_item_nombre_curso.click()

  ## SEARCH QUERY
  driver.implicitly_wait(5)
  btn_buscar = driver.find_element(By.ID, 'j_idt24:formCatalogoOC:j_idt44')
  btn_buscar.click()
...
#TRY TO LOAD PAGE
  while(try_load):
    ...
    try:
      ...
      search_query_on_page(driver,QUERY_INPUT)

      #GET LAST PAGE
      btn_control = driver.find_element(By.XPATH,'//*[@id="j_idt24:formCatalogoOC:tblDatos_paginator_bottom"]/a[4]')
  ...
  while(go):  
    ...
    while(try_load):
      ...
      try:
        ...
        report_file.close()
        ## GET TABLE HEADER
        table_header = driver.find_element(By.ID,'j_idt24:formCatalogoOC:tblDatos_head')
    ...
    while(page_number<page_checkpoint and page_number<final_page and not expired_session):
        try:
            ...
            btn_siguiente = driver.find_element(By.XPATH, '//*[@id="j_idt24:formCatalogoOC:tblDatos_paginator_bottom"]/a[3]')

            if (page_checkpoint - page_number)>10:
              btn_siguiente = driver.find_element(By.XPATH,'//*[@id="j_idt24:formCatalogoOC:tblDatos_paginator_bottom"]/span/a[10]')
    ...
    if (page_number >= final_page):
      ...
      while(condition):
        ...
        while(try_load):
          try:
            table_data = driver.find_element(By.ID,'j_idt24:formCatalogoOC:tblDatos_data')
...
if __name__==('__main__'):
    ...
    for i in range(N_BOT_DRIVERS):
        if i == 0:
          ...
          start_page_list.append(mark_page+1)
